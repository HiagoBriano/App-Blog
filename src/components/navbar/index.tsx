...
export default function Navbar() {
  ...
  return (
    <nav
      className={`bg-white dark:bg-gray-800 ${isScroll ? 'md:bg-white md:dark:bg-gray-800' : 'md:bg-transparent md:dark:bg-transparent'}`}
    >
      <div
        className={`max-w-screen-xl flex flex-wrap items-center justify-between mx-auto transition ${isScroll ? 'p-1' : 'p-4'} `}
      >
        ...
        <div className="flex items-center md:order-2 space-x-1 md:space-x-0 rtl:space-x-reverse">
          <div ref={dropdownRef}>
            ...
            <div
              className={`${isLocalOpen ? '' : 'hidden'} absolute z-50 my-2 ml-[-35px] text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-700`}
          ...
          <button
            ...
            type="button"
            className={`inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600 ${isMenuOpen && 'active'}`}
            aria-controls="navbar-sticky"
        ...
        >
          <ul
            className={`${isMenuOpen && 'bg-gray-50 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900'} flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 dark:border-gray-700`}
          >
